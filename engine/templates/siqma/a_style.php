...
?>
 <body bgcolor="#000000" background="/images/bg_bloo.gif">
  <br />
  <table id="maintable" <?= $session->main_style; ?> align="<?= $config->default_align; ?>" border="0" cellspacing="0" cellpadding="0" width="<?= $config->default_width; ?>">
   <tbody>
<?php
   ...
   if ((in_array($session->module, array_keys($config->addons_by_modules))) && (!in_array($session->sub, $config->no_addons_in_subactions)) && (!in_array($session->action, $config->no_addons_in_actions))) {
     ...
     print " <td width=\"80%\" align=\"right\" valign=\"top\" colspan=\"2\">";
     print "  <table id=\"addonstable\" align=\"left\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"99%\">";
     print "   <tbody>";
   }

    print "<tr>\n";
    print "<td width=\"100%\" height=\"100%\" align=\"right\" valign=\"top\" colspan=\"3\">\n";
