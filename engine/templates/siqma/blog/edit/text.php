<!-- $Id: text.php,v 1.6 2005/04/26 07:09:28 hunter Exp $ -->
        <tr>
	  ...
	  <? endif; ?>
 	  <form name="post" action="<?= $session->utils->makeHRURL("?module=blog&action=show&sub=change&id=".$session->id); ?>" method="POST">
	   ...
	   <table width="90%" align="center" valign="top">
	    ...
	    <tr id="header02" style="display: none; ">
	     ...
	     <td width="40%">
	       ...
	       <select name="category" style="width: 100%" value="<?= $session->blog['category']; ?>"><?= $session->utils->getCategoriesList("", true); ?></select>
	      <? endif; ?>
	     </td>
...
<!-- eof $Id: text.php,v 1.6 2005/04/26 07:09:28 hunter Exp $ -->
