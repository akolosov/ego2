<!-- $Id: text.php,v 1.1 2005/05/11 07:37:45 hunter Exp $ -->
	  ...
	  <? endif; ?>
 	  <br /><form name="post" action="<?= $session->utils->makeHRURL("?module=comments&action=show&sub=append&tid=".$session->tid."&board=".$session->board); ?>" method="<?= $config->default_method; ?>">
...
<!-- eof $Id: text.php,v 1.1 2005/05/11 07:37:45 hunter Exp $ -->
