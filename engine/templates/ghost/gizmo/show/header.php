<!-- $Id: header.php,v 1.1 2005/05/11 07:38:28 hunter Exp $ -->
	 ...
	 <a href="<?= $session->utils->makeHRURL("?module=comments&action=show&tid=".$session->gizmo['id']."&board=".$session->board."#cf"); ?>" title="[<?= $i18n->more; ?>]"><span class="topichead"><?= $session->gizmo['title']; ?></span></a>
         </td>
