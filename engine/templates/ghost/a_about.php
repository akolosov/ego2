<!-- $Id: a_about.php,v 1.1 2005/05/11 07:38:21 hunter Exp $ -->
  <tr>
    <td width="100%" align="left" valign="middle" colspan="3">
     &nbsp;
    </td>
  </tr>
<? if (file_exists($config->about_modules_path."/".$session->language."/".$config->default_locale_short."/about_me.php")): ?>
  <tr>
  ...
  <tr>
    ...
    <?php require($config->about_modules_path."/".$session->language."/".$config->default_locale_short."/about_me.php"); ?>  
    </td>
  </tr>
  <tr>
...
<? if (file_exists($config->about_modules_path."/".$session->language."/".$config->default_locale_short."/about_ngine.php")): ?>
  ...
  <tr>
   <td width="80%" id="footer" align="right" valign="middle" colspan="3">
    <span class="topiclinx"><a href="<?= $config->ngine_url; ?>files/engine/">[<?= $i18n->download; ?>]</a></span>
   </td>
  </tr>
<? endif; ?>