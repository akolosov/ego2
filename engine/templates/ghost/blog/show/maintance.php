	<tr>
	  ...
	  <table width="100%" align="center">
	   <tr>
	    ...
	    <td align="center" valign="middle" class="navcell" <?= (($session->sub=="archive")?" id=\"current\"":"")?>><span class="maintance"><a href="<?= $session->utils->makeHRURL("?module=".$session->module."&action=archive"); ?>"><?= $i18n->archive; ?></a></span></td>
