<!-- $Id: text.php,v 1.3 2005/02/10 06:09:22 hunter Exp $ -->
	  ...
	  <? endif; ?>
 	  <br /><form name="post" action="<?= $session->utils->makeHRURL("?module=comments&action=show&sub=add&id=".sizeof($comments)."&tid=".$session->tid."&board=".$session->board); ?>" method="<?= $config->default_method; ?>">
	   <table width="95%" align="center" valign="top">
	    ...
	    <tr id="header02">
	     ...
	     <td width="90%" colspan="3"><input type="text" style="width: 100%" name="topic" value="<?=(!is_null($session->post_err))?$session->data['topic']:$session->all_title; ?>"></td>
	    </tr>
...
<!-- eof $Id: text.php,v 1.3 2005/02/10 06:09:22 hunter Exp $ -->
