  <tr>
    <td class="b-border" id="header" width="60%" align="left" valign="middle">
    ...
    <td class="b-border" id="header" width="20%" align="right" valign="middle"><? if ($config->use_visual_styles): ?>
    ...
    <td class="b-border" id="header" width="20%" align="right" valign="middle"><? if ($config->use_visual_themes): ?>
