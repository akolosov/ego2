<!-- $Id: text.php,v 1.6 2005/04/26 07:09:43 hunter Exp $ -->
        <tr>
...
?>
	...
	<? if ($config->use_url_forms): ?>
	    <tr><td id="header" class="b-border" colspan="4"><span class="maintance"><a onClick="hideIt('addons01'); hideIt('addons02'); "><?= $i18n->addons; ?></a></span></td></tr>
...
<!-- eof $Id: text.php,v 1.6 2005/04/26 07:09:43 hunter Exp $ -->
